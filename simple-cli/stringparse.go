...
func main() {
	...
	// Adding a new choise for --metric of 'substring' and a new --substring flag
	...
	countUniquePtr := countCommand.Bool("unique", false, "Measure uniq values of a metric")
	...
	countCommand.Var(&countStringList, "substringList", "A comma separated list of substring to be counted.")
	...
	// os.Arg[1] will be tue subcommand
	...
	// Parse the flags for appropiate FlagSet
	...
	// FlagSet.Parse() will evaluate to false if no flags were parsed (i.e. the user did not provided any flags)
